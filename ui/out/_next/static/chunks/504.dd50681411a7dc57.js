...
const functions = {
    setActiveInstanceToBerkeley: async (args)=>{
        const Berkeley = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.Network("https://api.minascan.io/node/berkeley/v1/graphql");
    ...
    createMintTransaction: async (args)=>{
        ...
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(()=>{
            state.zkapp.mint(o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(publicKey58), amount);
        });
...
/******/ 			if (chunkId === 674) return "static/chunks/982f5ae2-54dd544108bc613a.js";
/******/ 			// return url for filenames based on template
/******/ 			return "static/chunks/" + chunkId + "." + "d0822fc44210e34e" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
