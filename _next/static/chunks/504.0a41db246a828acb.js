...
const functions = {
    ...
    loadContract: async ()=>{
        const { TokenContract } = await __webpack_require__.e(/* import() */ 220).then(__webpack_require__.bind(__webpack_require__, 7220));
        state.TokenContract = TokenContract;
    },
    compileContract: async ()=>{
        if (state.TokenContract) await state.TokenContract.compile();
    },
    fetchAccount: async (param)=>{
        let { publicKey58 } = param;
        const publicKey = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(publicKey58);
        return await (0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .fetchAccount */ .$G)({
            publicKey
        });
    },
    initZkappInstance: async (param)=>{
        let { publicKey58 } = param;
        const publicKey = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(publicKey58);
    ...
    createSignature: async (param)=>{
        let { receiver, amount, privKey } = param;
        const signature = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Signature */ .Pc.create(o1js__WEBPACK_IMPORTED_MODULE_0__/* .PrivateKey */ ._q.fromBase58(privKey), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt64 */ .zM.from(amount).toFields().concat(o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(receiver).toFields()));
    },
    createBurnTransaction: async (param)=>{
        let { publicKey58, amount } = param;
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(()=>{
            var _state_zkapp;
            (_state_zkapp = state.zkapp) === null || _state_zkapp === void 0 ? void 0 : _state_zkapp.burn(o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(publicKey58), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt64 */ .zM.from(amount));
        });
        state.transaction = transaction;
    },
    createTransferTransaction: async (param)=>{
        let { senderPublicKey58, receiverPublicKey58, amount } = param;
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(()=>{
            var _state_zkapp;
            (_state_zkapp = state.zkapp) === null || _state_zkapp === void 0 ? void 0 : _state_zkapp.transfer(o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(senderPublicKey58), o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58(receiverPublicKey58), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt64 */ .zM.from(amount));
        });
        state.transaction = transaction;
    },
    ...
    getTransactionJSON: async ()=>{
        var _state_transaction;
        return (_state_transaction = state.transaction) === null || _state_transaction === void 0 ? void 0 : _state_transaction.toJSON();
    }
};
if (true) {
...
/******/ 			if (chunkId === 674) return "static/chunks/982f5ae2-d293915b223897cf.js";
/******/ 			// return url for filenames based on template
/******/ 			return "static/chunks/" + chunkId + "." + "98df0632fe5ffdf4" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/usdm/_next/";
/******/ 	}();
/******/ 	
